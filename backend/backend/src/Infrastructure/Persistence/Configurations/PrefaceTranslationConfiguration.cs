...
<p>&nbsp;</p><p><strong>Contacteer ons via</strong><a href=""mailto: internship@inetum-realdolmen.world""> internship@inetum-realdolmen.world</a> <strong>om jouw stageplaats aan te vragen</strong></p>", 
        ...
        {
            Id = 7, 
            Content = "<p>Naast ontwikkelingen in High Code (.NET, Java, ...) werkt Inetum-Realdolmen ook aan Enterprise-projecten in Low Code en dat in verschillende omgevingen: Microsoft Power-Platform, Salesforce, Mendix, Appian en Outsystems.</p>",
            UnitId = 3,
            LanguageId = 1,
            IsDeleted = false,
            LastModifiedDate = DateTime.UtcNow,
        ...
        {
            Id = 8, 
            Content = "<p>En plus des d&eacute;veloppements en High Code (.NET, Java, ...), Inetum-Realdolmen travaille &eacute;galement sur des projets d&#39;entreprise en Low Code et ce, dans divers environnements : Microsoft Power-Platform, Salesforce, Mendix, Appian et Outsystems.</p>",
            UnitId = 3,
            LanguageId = 2,
            IsDeleted = false,
            LastModifiedDate = DateTime.UtcNow,
        ...
        {
            Id = 9, 
            Content = "<p>In addition to developments in High Code (.NET, Java, ...), Inetum-Realdolmen is also working on Enterprise projects in Low Code and that in various environments: Microsoft Power-Platform, Salesforce, Mendix, Appian and Outsystems.</p>",
            UnitId = 3,
            LanguageId = 3,
            IsDeleted = false,
            LastModifiedDate = DateTime.UtcNow,
