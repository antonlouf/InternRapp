...
namespace backend.Infrastructure.Migrations
{
    ...
    public partial class initial : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.InsertData(
                table: "Locations",
                columns: new[] { "Id", "City", "HouseNumber", "InternShipId", "StreetName", "ZipCode" },
                values: new object[,]
                {
                    { 1, "Huizingen", 42, null, "Vaucampslaan", "1654" },
                    { 2, "Gent", 4, null, "Gaston Crommenlaan", "9050" },
                    { 3, "Kontich", 26, null, "Prins Boudewijnlaan", "2550" }
                });
