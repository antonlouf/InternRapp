...
export function convertFormsArrayToObjectForNewInternship(formArray: FormArray):InternshipTranslation[]{
...
export function convertFormsArrayToObjectForUpdatedInternship(formArray: FormArray):InternshipTranslationUpdatePostDto[]{
